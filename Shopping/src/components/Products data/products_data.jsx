          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <div className="md:py-8">
              ...
              <div className="mb-4 md:mb-6">
                <span className="mb-3 inline-block text-sm font-semibold text-gray-500 md:text-base">Subtitle</span>
              ...
              <div className="mb-8 md:mb-10">
                <span className="mb-3 inline-block text-sm font-semibold text-gray-500 md:text-base">authors</span>
