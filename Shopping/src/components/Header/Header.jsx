      ...
      <div className="mx-auto max-w-screen-2xl px-2 md:px-2">
        <header className="flex items-center justify-between py-2 md:py-2">
          ...
          <nav className="hidden gap-12 lg:flex">
            <Link
              to="#"
              className="text-lg font-semibold text-gray-600 transition duration-100 hover:text-indigo-500 active:text-indigo-700 border-double p-1.5 border-2 border-black"
            >
            ...
            >
              <img className="w-12" src="/src/assets/images/cart.png" alt="" />
            </Link>
          </nav>
